...
> A production ready hate speech detection system built with DistilBERT, featuring rule-based sarcasm detection for indirect hate, SHAP explainability with confidence visualization, multilingual support (English + Hindi), and a deployed Streamlit web application. contra
